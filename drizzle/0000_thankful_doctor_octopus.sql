...
--> statement-breakpoint
CREATE TABLE "user_subscription_payos" (
	"id" serial PRIMARY KEY NOT NULL,
	"user_id" text NOT NULL,
	...
	CONSTRAINT "user_subscription_payos_user_id_unique" UNIQUE("user_id"),
	CONSTRAINT "user_subscription_payos_order_code_unique" UNIQUE("order_code")
);
--> statement-breakpoint
ALTER TABLE "challenge_games" ADD CONSTRAINT "challenge_games_challenge_id_challenges_id_fk" FOREIGN KEY ("challenge_id") REFERENCES "public"."challenges"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
